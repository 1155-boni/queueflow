...
const GovernmentDashboard = ({ user }) => {
  ...
  return (
    <div className="dashboard government-dashboard">
      <h2>{t('app.welcome', { username: user.username })} - Government Official</h2>
      <div className="government-features">
        <div className="feature-card">
          <h3>🏛️ Public Services</h3>
          <p>Manage queues for passport applications, license renewals, and government services</p>
        </div>
        <div className="feature-card">
          <h3>📋 Administrative Tasks</h3>
          <p>Handle document processing, certifications, and official paperwork efficiently</p>
        </div>
        <div className="feature-card">
          <h3>📈 Service Analytics</h3>
          <p>Monitor public service delivery and citizen satisfaction metrics</p>
        </div>
      </div>
